...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.ow0ty.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
    ...
    try {
        ...
        app.get('/available', async (req, res) => {
            ...
            services.forEach(service => {
                ...
                const available = service.slots.filter(slot => !bookedSlots.incudes(slot));
...
app.listen(port, () => {
    console.log(`Ohh Doctors uncles....Example app listening on port ${port}`)
})